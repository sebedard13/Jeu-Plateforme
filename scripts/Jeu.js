class Jeu {
    ...
    fAnimation(){
        ...
        let persoAnim = new createjs.Sprite(this.chargeur.getResult("perso2"));
        persoAnim.gotoAndPlay("marcher");
        persoAnim.y = this.stage.canvas.height/2;
        persoAnim.x = 213;
        ...
        intro.y = this.stage.canvas.height*2/3;
        intro.x = this.stage.canvas.width/2;
    ...
    fDemarrer(e) {
        ...
        this.perso = new Perso(this.chargeur.getResult("perso2"));
        ...
        objet.y = this.stage.canvas.height/2;
        objet.x = this.stage.canvas.width /2;
        this.containFin.addChild(objet);

        objet =  new createjs.Bitmap(this.chargeur.getResult("btCheck"));
        objet.regX = objet.getBounds().width/2;
        objet.regY = objet.getBounds().height/2;
        objet.y = this.stage.canvas.height - 110;
        objet.x = this.stage.canvas.width /2;
    ...
    fToLost(){
        ...
        this.perso.y = this.stage.canvas.height/2;
        this.perso.x = this.stage.canvas.width/2;
        this.perso.collisionBox.y = this.stage.canvas.height/2;
        this.perso.collisionBox.x = this.stage.canvas.width/2;
        ...
        objet.regX = objet.getBounds().width/2;
        objet.regY = objet.getBounds().height/2;
        objet.y = this.stage.canvas.height - 135;
        objet.x = this.stage.canvas.width /2;
